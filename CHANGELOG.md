...
All notable changes to this repository are documented here. Published harness surfaces are at **2.1.0** unless noted:

| Surface | Package / manifest | Version |
| --- | --- | --- |
| Monorepo root | `morning-star` (`package.json`) | **2.1.0** |
| CLI | `@mstar-harness/cli` (`packages/cli`) | **2.1.0** |
| Engine | `@mstar-harness/engine` (`packages/engine`) | **2.1.0** |
| OpenCode plugin | `@mstar-harness/opencode` (`packages/opencode`) | **2.1.0** |
| Cursor plugin | `.cursor-plugin/plugin.json` | **2.1.0** |
| Codex plugin | `.codex-plugin/plugin.json` | **2.1.0** |
| Kimi plugin | `.kimi-plugin/plugin.json` | **2.1.0** |
| ZCode plugin | `.zcode-plugin/plugin.json` | **2.1.0** |
| omp plugin | `.omp-plugin/plugin.json` / `.claude-plugin/plugin.json` | **2.1.0** |
| Agent Plugins manifest | `plugin.json` | **2.1.0** |

...
| Checkpoint pointer | The advisory only points at the shared Phase-2 rescheduling checkpoint (`mstar-iteration/references/phase-2-worktree-lease.md` §2.4; frozen vocabulary in `{SPECS_DIR}/phase2-proactive-scheduling.md`). It never copies the decision matrix — this section does not either. |

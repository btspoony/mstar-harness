...
| `qa-engineer` | `mstar-review-qc` (+ `references/qa-acceptance-gate.md`), `mstar-branch-worktree`, `mstar-plan-artifacts` (closing R#); `mstar-design-md` when verifying visual output |

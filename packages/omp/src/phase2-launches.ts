 ...
 *
 * Primary spec: `mstar-host/references/omp-phase2-instances.md` §C (capacity, reservation
 * and recovery) + §D (skill-driven transport boundary). This module owns exactly one file —

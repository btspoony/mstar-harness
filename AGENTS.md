...
Releases are PR-driven and mostly automated. Every release ships one version across all 11 surfaces (root + 3 npm packages + 7 plugin manifests [6 host + portable Agent Plugins] + INSTALL.md marketplace example).
